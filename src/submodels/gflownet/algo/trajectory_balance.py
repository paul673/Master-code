...
from src.submodels.gflownet.algo.graph_sampling import GraphSampler
from src.submodels.gflownet.config import Config
from src.submodels.gflownet.envs.graph_building_env import (
    ActionIndex,
    Graph,
    GraphAction,
...
from src.submodels.gflownet.trainer import GFNAlgorithm
from src.submodels.gflownet.utils.misc import get_worker_device
...
class TrajectoryBalance(GFNAlgorithm):
    ...
    def __init__(
        ...
        # Paul Add parameter to config
        #self.mask_invalid_rewards = False
        self.mask_invalid_rewards = self.cfg.mask_invalid_rewards
        # TODO: Paul config for loss clipping based on variance 
        self.std_cut_losses = self.cfg.std_cut_losses
        self.std_cut_scale = self.cfg.std_cut_scale
    ...
    def compute_batch_losses(
        ...
        if self.std_cut_losses:
            ...
            loss_cap = traj_losses_mean + traj_losses_std * self.std_cut_scale
