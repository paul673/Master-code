...
import src.submodels.gflownet.models.mxmnet as mxmnet
from gflownet import LogScalar, ObjectProperties
from src.submodels.gflownet.algo.envelope_q_learning import EnvelopeQLearning, GraphTransformerFragEnvelopeQL
from src.submodels.gflownet.algo.multiobjective_reinforce import MultiObjectiveReinforce
from src.submodels.gflownet.config import Config
from src.submodels.gflownet.data.data_source import DataSource
from src.submodels.gflownet.data.qm9 import QM9Dataset
from src.submodels.gflownet.envs.mol_building_env import MolBuildingEnvContext
from src.submodels.gflownet.tasks.qm9 import QM9GapTask, QM9GapTrainer
from src.submodels.gflownet.tasks.seh_frag_moo import RepeatedCondInfoDataset, aux_tasks
from src.submodels.gflownet.utils import metrics
from src.submodels.gflownet.utils.conditioning import FocusRegionConditional, MultiObjectiveWeightedPreferences
from src.submodels.gflownet.utils.multiobjective_hooks import MultiObjectiveStatsHook, TopKHook
from src.submodels.gflownet.utils.sqlite_log import SQLiteLogHook
from src.submodels.gflownet.utils.transforms import to_logreward
...
class QM9GapMOOTask(QM9GapTask):
    ...
    The proxy is pretrained, and obtained from the original GFlowNet paper, see `src.submodels.gflownet.models.bengio2021flow`.
    """
